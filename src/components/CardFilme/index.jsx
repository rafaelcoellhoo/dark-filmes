export default function CardFilme({ filme }) {
  return (
    <div className="w-[280px] h-[250px] flex flex-col rounded-lg bg-[#222222] cursor-pointer border border-transparent hover:border-[#8f7bd8] transition-all duration-300 ease-in-out">
